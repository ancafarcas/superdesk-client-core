...
AnalyticsCtrl.$inject = ['$scope', 'api', 'desks', 'workspaces', 'preferencesService', 'storage',
    'gettext', 'multi', 'config', '$timeout', 'savedSearch'];

export function AnalyticsCtrl($scope, api, desks, workspaces, preferencesService, storage,
        gettext, multi, config, $timeout, savedSearch) {
